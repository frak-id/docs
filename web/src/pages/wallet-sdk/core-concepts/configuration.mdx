---
title: Nexus SDK Configuration
description: Learn how to configure the Nexus SDK for your application
date: 2024-09-05
---

# Configuration

Proper configuration is crucial for the Nexus SDK to function correctly in your application. This guide will walk you through the configuration options and how to set them up.

## Configuration Object

The Nexus SDK uses a configuration object to set up its behavior. Here's the structure of the `NexusWalletSdkConfig` object:
 ...
 * @property {string} walletUrl - The URL of the Nexus Wallet service
 * @property {Object} metadata - Metadata about your application
 * @property {string} metadata.name - The name of your application
 * @property {string} [metadata.css] - URL to a CSS file for styling the Nexus Wallet interface
...
This is the URL of the Nexus Wallet service. Use one of the following values:
...
- `name`: The name of your application. This will be displayed in the Nexus Wallet interface.
- `css` (optional): A URL to a CSS file that can be used to style the Nexus Wallet interface when it's displayed in your application.

### `domain` (optional)

The domain of your application. This is used to identify your application in the Nexus ecosystem.
...
In a vanilla JavaScript application, you'll pass this configuration when creating a Nexus client:
...
1. **Environment-based Configuration**: Consider using different configurations for development and production environments. This allows you to use the development Nexus Wallet during testing.
...
By properly configuring the Nexus SDK, you ensure that it can communicate effectively with the Nexus Wallet and provide a seamless experience for your users.

## Next Steps

Now that you've configured the Nexus SDK, you're ready to start implementing its features. Check out our guides on [Tracking User Interactions](/wallet-sdk/core-concepts/interactions) and [Setting Up Rewards](/wallet-sdk/core-concepts/rewards-and-campaigns) to learn more about what you can do with the SDK.
