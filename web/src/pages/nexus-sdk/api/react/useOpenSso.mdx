---
title: useOpenSso
description: React hook to open the Nexus Wallet SSO (Single Sign-On) interface
date: 2024-09-06
---
...
## Summary
The `useOpenSso` hook provides a convenient way to open the Nexus Wallet's Single Sign-On (SSO) interface. This allows users to authenticate or connect their wallet seamlessly within your application.
...
## Notes
- This hook triggers the opening of the Nexus Wallet SSO interface.
...
## Related
- [openSso](/nexus-sdk/api/actions/openSso) - Core action for opening the SSO interface
