...
- **Community Token**: Keep your users engaged with your own community token, sending them notification about your latest contents and offer them associated perks.
- **Subscription Gating**: Unlock access to your entire content catalog for a specified duration.
- **Stake to access**: Require users to stake a certain amount of tokens to access premium content.
...
The Nexus Wallet SDK is continuously evolving to meet the needs of developers and content publishers. Here are some of the features we are planning to add in the coming month:
 1. **Wagmi Connector**: Integrate the Nexus SDK with the [Wagmi](https://wagmi.sh/) to simplify the interaction with the Nexus Wallet
 2. **Notification System**: Implement a notification system to keep users informed about their transactions and account activity
 3. **Paymaster Integration**: Enable seamless integration with your own Paymaster for gasless transactions and better onboarding of your users on the blockchain world
 4. **EUID Integration**: Identify your users using the [European User Unified ID (EUID)](https://partner.thetradedesk.com/v3/portal/euid/overview) to comply with the latest privacy regulations