...
description: Types for displaying modals in the Nexus Wallet SDK
date: 2024-09-05
---

# DisplayModalType

The `DisplayModalType` encompasses various types used for displaying modals in the Nexus Wallet SDK.
