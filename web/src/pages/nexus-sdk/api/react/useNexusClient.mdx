...
## Related
- [NexusIFrameClientProvider](/nexus-sdk/api/react/NexusIFrameClientProvider) - Provider component that supplies the Nexus client
- [NexusClient](/nexus-sdk/api/types/NexusClient) - Type definition for the Nexus Wallet client
