...
description: Function to send user interactions to the Nexus Wallet
date: 2024-09-05
---
...
## Summary
The `sendInteraction` function sends user interactions to the Nexus Wallet, allowing for on-chain recording of user activities within your application.

For a more in-depth explanation of interactions, please refer to our [Interactions Concept Guide](/nexus-sdk/core-concepts/interactions).
...
In this example, we import the `sendInteraction` function and the Nexus client. We then call `sendInteraction` with the necessary interaction parameters, including the prepared interaction data and an optional validation signature.
