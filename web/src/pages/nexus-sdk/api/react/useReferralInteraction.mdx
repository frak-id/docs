...
description: React hook for automatic handling of referral interactions in the Nexus ecosystem
date: 2024-09-06
---
...
## Summary
The `useReferralInteraction` hook provides a comprehensive solution for managing referral interactions within the Nexus ecosystem. It automatically detects referral information from the URL, handles wallet connections, submits referral interactions, and updates the referral context, all while preventing self-referrals.
...
## Related
- [useSendInteraction](/nexus-sdk/api/react/useSendInteraction) - Hook for sending interactions, used internally by useReferralInteraction
- [useWalletStatus](/nexus-sdk/api/react/useWalletStatus) - Hook for checking wallet status, used internally by useReferralInteraction
