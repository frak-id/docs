...
## Related
- [useNexusConfig](/wallet-sdk/api/react/useNexusConfig) - Hook to access the Nexus SDK configuration
- [NexusIFrameClientProvider](/wallet-sdk/api/react/NexusIFrameClientProvider) - Provider component for the Nexus client instance
