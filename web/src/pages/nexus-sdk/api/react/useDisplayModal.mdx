...
## Related
- [displayModal](/nexus-sdk/api/actions/displayModal) - Core action for displaying modals
...
- [DisplayModalType](/nexus-sdk/api/types/DisplayModalType) - Type definition for different modal step types
