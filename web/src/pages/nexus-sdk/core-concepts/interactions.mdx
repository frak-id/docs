...
For detailed information on specific interaction types, refer to the [Press Interactions](/nexus-sdk/api/interactions/PressInteractionEncoder) and [Referral Interactions](/nexus-sdk/api/interactions/ReferralInteractionEncoder) documentation.
