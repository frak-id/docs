...
Welcome to the Nexus SDK documentation!

The Nexus SDK provides developers with powerful tools to integrate seamless Web3 interactions into their applications, leveraging the user-friendly Nexus Wallet.

## Nexus Wallet

The Nexus Wallet is a cutting-edge cryptocurrency wallet designed with a strong emphasis on user experience. Built using the latest technologies, including [Account Abstraction](https://eips.ethereum.org/EIPS/eip-4337) and [WebAuthn](https://w3c.github.io/webauthn/), the Nexus Wallet simplifies the onboarding process and enhances Web3 interactions.
...
The Nexus Wallet is fully compatible with the WalletConnect standard, ensuring compatibility with a wide range of dApps and Web3 services.

## Nexus SDK

The Nexus SDK is designed to streamline the integration of Web3 interactions into your applications, providing a comprehensive set of tools and features for various use cases.
...
By integrating the Nexus SDK, you can:
